...
describe('WooCommerceSyncController', () => {
    ...
    describe('triggerSync', () => {
        it('should trigger sync and return immediately', async () => {
        ...
        it('should not wait for sync completion', async () => {
        ...
        it('should handle sync errors gracefully', async () => {
            ...
            // Should not throw
            await expect(controller.triggerSync()).resolves.not.toThrow()
        })
    })
})
